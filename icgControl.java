...
public class icgControl {
	...
	static int getType(String loop) {
		if (loop.contains("while"))
			return 0;	//for while control loop
		else if (loop.contains("for")) 
			return 1;	//for for control loop
		else
			return 2; 	//for switch control loop
	}
}

/*
OUTPUT
C:\Users\Niti123\Desktop\coding\spcc>javac icgControl.java

C:\Users\Niti123\Desktop\coding\spcc>java icgControl
